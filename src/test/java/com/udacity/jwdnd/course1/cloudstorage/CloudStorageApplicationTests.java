...
public class CloudStorageApplicationTests {
	private static String firstName = "Saleh";
	private static String lastName = "Alibrahim";
	private static String userName = "root";
	private static String password = "supersecet";
	private static String noteTitle = "This is my notes";
	private static String noteDescription = "my first ever notes";
	private static String credURL = "https://sibrahim.me";
	...
	public void noteCreationTest() {
		...
		WebElement newNote = driver.findElement(By.id("newnote-button"));
		...
		WebElement savechanges = driver.findElement(By.id("note-submit"));
		savechanges.click();
		Assertions.assertEquals("Home", driver.getTitle());
	...
	public void noteUpdationTest() {
		...
		for (int i = 0; i < notesList.size(); i++) {
			WebElement element = notesList.get(i);
			editElement = element.findElement(By.id("edit-note"));
			if (editElement != null){
				break;
			}
		}
	...
	public void noteDeletionTest() {
		...
		for (int i = 0; i < notesList.size(); i++) {
			WebElement element = notesList.get(i);
			deleteElement = element.findElement(By.id("note-delete"));
	...
	public void credentialCreationTest() {
		...
		wait.withTimeout(Duration.ofSeconds(30));
		WebElement newCred = driver.findElement(By.id("create-credential"));
		...
		jse.executeScript("arguments[0].click()", credTab);
		WebElement credsTable = driver.findElement(By.id("credential-table"));
	...
	public void credentialUpdationTest() {
		...
		credTab = driver.findElement(By.id("nav-credentials-tab"));
		jse.executeScript("arguments[0].click()", credTab);
		credsTable = driver.findElement(By.id("credential-table"));
